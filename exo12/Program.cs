...
namespace exo12
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (victoryPc < 10 && victoryUt < 10)
            {
                Console.WriteLine("\nVeuillez entrer un chiffre entre 0 et 2");
                if (int.TryParse(Console.ReadLine(), out nbUtilisateur) && nbUtilisateur <= 2 && nbUtilisateur >=0) 
                {
                    nbPc = rng.Next(0, 3);
